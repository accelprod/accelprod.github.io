...
const PAIN_POINTS = [
  "AI proof-of-concepts never become reliable products",
  "LLM features ship without evaluation or observability",
  "Architecture decisions get deferred until the system breaks",
  "Early shortcuts make the production version harder",
];
        ...
        >
          <div>
            ...
            <p style={{ fontSize: 15, color: "var(--text2)", lineHeight: 1.75, fontWeight: 400, marginBottom: 28 }}>
              The hard part is not the first prompt or prototype. It is turning the idea into software people can rely on:
            </p>
            ...
            <p style={{ fontSize: 15, color: "var(--text2)", lineHeight: 1.75, fontWeight: 400 }}>
              Accelprod focuses on the system around the model: product UX, data flow, backend architecture, deployment, monitoring, and iteration.
            </p>
          </div>
          ...
          <div style={{ paddingTop: 8 }}>
            ...
            >
              ...
              <p style={{ fontSize: 15, color: "var(--text)", fontWeight: 500, lineHeight: 1.7, marginBottom: 0 }}>
                A product engineering team that can clarify the AI workflow, make the right technical calls, and leave your team with software it can actually operate.
              </p>
            </div>
