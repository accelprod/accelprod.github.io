  ...
  return (
    ...
    >
      ...
      <div ref={ref} className="rev" style={{ position: "relative", zIndex: 1 }}>
        ...
        >
          Ready to build<br />
          <span className="gt-anim">with AI acceleration?</span>
        </h2>

        <p style={{ fontSize: 18, color: "var(--text2)", fontWeight: 400, maxWidth: 500, margin: "0 auto 40px" }}>
          From MVPs to production systems, we help teams ship modern software products faster.
        </p>
        ...
        >
          {["Product engineering consult", "MVP planning", "Production systems", "Post-launch iteration"].map((t, i) => (
