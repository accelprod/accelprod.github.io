    ...
    >
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", position: "relative", zIndex: 1 }}>
        ...
        <div style={{ marginBottom: 36 }}>
          ...
          <h2 className="font-display" style={{ fontSize: "clamp(26px, 3.5vw, 44px)", fontWeight: 700, letterSpacing: "-1.2px", lineHeight: 1.08, color: "var(--text)", margin: "0 0 14px" }}>
            How we work
          </h2>
          <p style={{ fontSize: 15, color: "var(--text2)", maxWidth: 500, lineHeight: 1.7, fontWeight: 400, margin: 0 }}>
            A focused workflow from product discovery to production launch.
          </p>
        </div>
            ...
            <div style={{ padding: "24px 28px" }}>
              ...
              <div style={{ marginBottom: 20 }}>
                ...
                <div style={{ fontSize: 12, color: "var(--text3)", fontFamily: "var(--mono)" }}>
                  with Accelprod · vs {phase.traditional} traditionally
                </div>
              </div>
