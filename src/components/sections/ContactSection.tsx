...
const schema = z.object({
  ...
  message: z.string().min(10, "Please describe your problem").max(2000),
...
const PROCESS_STEPS = [
  {
    title: "A product engineer reviews it",
    body: "Your message goes straight to the team that scopes and builds.",
  },
  {
    title: "30-min product engineering consult",
    body: "Leave with scope, fit, risks, and a practical next step.",
  },
  {
    title: "Clear delivery roadmap",
    body: "Architecture, AI acceleration opportunities, stack, timeline, and delivery roadmap.",
  },
  {
    ...
    >
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        ...
        <h2 className="font-display" style={{ fontSize: "clamp(28px, 4vw, 48px)", fontWeight: 700, letterSpacing: "-1.2px", lineHeight: 1.08, color: "var(--text)", marginBottom: 14 }}>
          Tell us what product you're building.
        </h2>
        <p style={{ fontSize: 16, color: "var(--text2)", maxWidth: 500, lineHeight: 1.7, fontWeight: 400, marginBottom: 36 }}>
          Share the idea, workflow, or system you want to build. We'll respond with a clear technical next step.
        </p>
          ...
          <div>
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ fontSize: 12, color: "var(--text2)", fontWeight: 400 }}>
                  30 minutes. No pitch deck. Just product and technical clarity.
                </div>
              </div>
            ...
            >
              ...
              {submitted ? (
                ...
                >
                  <input type="text" tabIndex={-1} autoComplete="off" {...register("website")} style={{ display: "none" }} />
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                    ...
                    >
                      ...
                      <option value="ai-agents">AI agents or knowledge system</option>
                  ...
                  >
                    {isSubmitting ? "Sending..." : "Discuss Your Product Idea →"}
                  </button>
                </form>
              )}
            </div>
