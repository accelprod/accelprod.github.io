    ...
    <>
      ...
      >
        ...
        <div className="hidden nav:flex" style={{ gap: 10, alignItems: "center" }}>
          <ThemeToggle />
          <a href="#contact" className="btn-ghost">Plan your MVP</a>
          <a href="#contact" className="btn-grad">Discuss your product idea</a>
        </div>
      ...
      {mobileOpen && (
        ...
        >
          ...
          <div style={{ display: "flex", gap: 10, paddingTop: 8 }}>
            <a href="#contact" className="btn-ghost" onClick={closeMobile}>Plan your MVP</a>
            <a href="#contact" className="btn-grad" onClick={closeMobile}>Discuss your product idea</a>
          </div>
        </div>
      )}
    </>
